...
const Navigate = () => {
    return <div className="nav">
        ...
        <div className="nav_item"><NavLink to={"/photos"}> <FaImages style={{ height: "20px" }} /> Albums </NavLink></div>
        <div className="nav_item"><NavLink to={"/users"}> <FaUser style={{ height: "20px" }} /> Users </NavLink></div>
    </div>
}
